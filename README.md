...
Дополнительно: небольшая утилита [builder](https://github.com/ilvoron/gulp-builder) для сборки проектов из проектов (да, звучит странно). Работает только с этим шаблоном.
